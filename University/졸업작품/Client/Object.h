...
public:
    ...
    ID3D11RasterizerState			*m_pd3dRasterizerState_Wire;
...
public:
	...
	void SetObjectType(unsigned int type) { m_Objecttype = type; }
    ...
    void SetWireFlag(bool flag) { m_bWireFrame = flag; }
    bool GetWireFlag() { return m_bWireFrame; }

	void SetPosition(float x, float y, float z);
	void SetPosition(D3DXVECTOR3 d3dxvPosition);

	void SetLookAndGenerate(D3DXVECTOR3 d3dxvLook_vector);

	void Move(D3DXVECTOR3 d3dxvPosition);
...
public:
	...
	virtual void CreateBlendState(ID3D11Device *pd3dDevice) {
		...
		pd3dDevice->CreateBlendState(&omDesc, &m_pd3dBlendState);
	}

    ID3D11RasterizerState* GetSolidRS() { return m_pd3dRasterizerState; }
    ID3D11RasterizerState* GetWireRS() { return m_pd3dRasterizerState_Wire; }
...
class CRadar : public CGameObject
{
public:
    ID3D11DepthStencilState			*m_pd3d_DSS_Radar_Step_1;
    ID3D11DepthStencilState			*m_pd3d_DSS_Radar_Step_2;
    ID3D11DepthStencilState			*m_pd3d_DSS_Radar_Step_3;

public:
    CRadar(int nMeshs) : CGameObject(nMeshs) {}
    virtual ~CRadar() {}
