...
protected:
	...
	CSpacePartition					space_partition;
...
public:
	...
	virtual void BuildObjects(ID3D11Device *pd3dDevice, std::vector<CGameObject*>& rObjectVec);
	...
	virtual CGameObject* GetGameObject(int index) { return m_ppObjects[index]; }
...
public:
	...
	CGameObject **GetNPC() { return m_ppObjects; }
	int GetNPC_Count() { return m_nObjects; }
...
class CSteerGSInstancedObjectShader : public CObjectsShader {
protected:
	CMesh *m_pMesh;
...
public:
	CSteerGSInstancedObjectShader(int nObjects = 1);
	virtual ~CSteerGSInstancedObjectShader();
...
// minimap
class CMinimapPlayerShader : public CShader
{
public:
    CMinimapPlayerShader() {}
    virtual ~CMinimapPlayerShader() {}

    virtual void CreateShader(ID3D11Device *pd3dDevice, UINT nType);
};

class CMinimapRadarShader : public CShader
{
public:
    CMinimapRadarShader() {}
    virtual ~CMinimapRadarShader() {}

    virtual void CreateShader(ID3D11Device *pd3dDevice, UINT nType);
};

class CMinimapRadarGridShader : public CShader
{
public:
    CMinimapRadarGridShader() {}
    virtual ~CMinimapRadarGridShader() {}
