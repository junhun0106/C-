...
public:
	...
	virtual void WalkAnimationSet() {}
	virtual void RunAnimationSet() {}
	virtual void ShootRifle() {}
	virtual void ShootPistol() {}
	virtual void IdleSet() {}
	virtual void HelloSet() {}
	virtual void ReloadRifle() {}
	virtual void ZombieWalk() {}

	virtual unsigned int GetAnimationState() { return 0; }
	virtual void SetAnimationState(unsigned int CurrentState) {}
	virtual void GetHandMatrix(D3DXMATRIX& mtxTransform)
	{
...
class CSkyDomeMesh : public CMeshTextured
{
public:
	CSkyDomeMesh(ID3D11Device *pd3dDevice);
	virtual ~CSkyDomeMesh();
};
...
public:
	...
	CAssetMesh(ID3D11Device *pd3dDevice, const std::string& filename, unsigned int type = 0);
	virtual ~CAssetMesh();
};
...
{
public:
	CCharacterMesh(ID3D11Device *pd3dDevice, float scale, const std::string& filename);
	virtual ~CCharacterMesh();
};

/////////////////////////////////////////////////////////////////////////////////////////////////
// minimap
class CMinimapPlayerMesh : public CMeshDiffused
{
public:
    CMinimapPlayerMesh(ID3D11Device *pd3dDevice);
    virtual ~CMinimapPlayerMesh();
};

class CMinimapEnemyMesh : public CMeshDiffused
{
public:
    CMinimapEnemyMesh(ID3D11Device *pd3dDevice);
    virtual ~CMinimapEnemyMesh();
};

class CMinimapRadarMesh : public CMeshTextured
{
public:
    CMinimapRadarMesh(ID3D11Device *pd3dDevice);
    virtual ~CMinimapRadarMesh();
};

class CMinimapRadarPlaneMesh : public CMeshTextured
{
public:
    CMinimapRadarPlaneMesh(ID3D11Device *pd3dDevice);
    virtual ~CMinimapRadarPlaneMesh();
};

class CMinimapRadarGridPlaneMesh : public CMeshTextured
{
public:
    CMinimapRadarGridPlaneMesh(ID3D11Device *pd3dDevice);
    virtual ~CMinimapRadarGridPlaneMesh();
};
...
//////////////////////////////////////////////////////////////////////////////////////////////////
// JUNG HUN MESH
class CGSRectMesh : public CMeshTextured
{
public:
	CGSRectMesh(ID3D11Device *pd3dDevice, float width, float height);
	virtual ~CGSRectMesh();
};